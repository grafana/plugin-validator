...
| Backend Binary / `backendbinary` | Checks that binary exists for plugins declaring a backend in plugin.json | None |
...
| Discoverability / `discoverability` | Warns about missing keywords and description that are used for plugin indexing in the catalogue | None|
