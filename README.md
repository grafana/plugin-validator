...
| HTML in Readme / `htmlreadme`                     | Detects if there are any html tags used in the README.md, as they will not render in the Plugin Catalog.                          | None                                                                  |
...
| Published / `published`                           | Detects whether any version of this plugin exists on the Plugin Catalog currently                                                 | None                                                                  |
