...
var (
	scanningFailure                    = &analysis.Rule{Name: "osvscanner-internal-failed", Severity: analysis.Warning}
	scanningParseFailure               = &analysis.Rule{Name: "osvscanner-internal-parse-failed", Severity: analysis.Warning}
	scanningSucceeded                  = &analysis.Rule{Name: "osvscanner-internal-succeeded", Severity: analysis.Warning}
	osvScannerCriticalSeverityDetected = &analysis.Rule{Name: "osvscanner-internal-critical-severity-vulnerabilities-detected", Severity: analysis.Warning} // This will be set to Error once stable
	osvScannerHighSeverityDetected     = &analysis.Rule{Name: "osvscanner-internal-high-severity-vulnerabilities-detected", Severity: analysis.Warning}
	osvScannerModerateSeverityDetected = &analysis.Rule{Name: "osvscanner-internal-moderate-severity-vulnerabilities-detected", Severity: analysis.Warning}
	osvScannerLowSeverityDetected      = &analysis.Rule{Name: "osvscanner-internal-low-severity-vulnerabilities-detected", Severity: analysis.Warning}
)

var Analyzer = &analysis.Analyzer{
	Name:     "osv-scanner-internal",
...
func run(pass *analysis.Pass) (interface{}, error) {
	...
	for _, scannerType := range scannerTypes {
		...
		if _, err := os.Stat(lockFile); err == nil {
			...
			filteredResults := FilterOSVInternalResults(data, lockFile)
