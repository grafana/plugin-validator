...
func run(pass *analysis.Pass) (interface{}, error) {
	...
	if err != nil {
		if os.IsNotExist(err) {
			pass.ReportResult(pass.AnalyzerName, unsignedPlugin, "unsigned plugin: no manifest file", "MANIFEST.txt file not found. Please refer to the documentation for how to sign a plugin.")
			return nil, nil
		} else {
